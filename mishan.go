...
import (
	...
	"github.com/stepinto/mishan/pkg/agent"
	...
	"github.com/stepinto/mishan/pkg/ui"
	"github.com/stepinto/mishan/pkg/ui/html"
	"k8s.io/klog/v2"
	"sigs.k8s.io/yaml"
)
...
// The default system prompt for cobra-based program.  This is generated from the command's help text.
func CobraPrompt(cmd *cobra.Command) string {
...
func Run(ctx context.Context, opt *Options, args []string) error {
	// klog setup must happen before other operations
	...
	// }
	// TODO(chaoshi): Support read cmd from STDIN.
	queryFromCmd := ""
	...
	// Register tools provided by user.
